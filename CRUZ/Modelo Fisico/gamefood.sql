...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-04-2026 a las 16:20:35
...
--
ALTER TABLE `detalle_pedido`
  MODIFY `ID_D_P` int(11) NOT NULL AUTO_INCREMENT;
